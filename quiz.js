...
const CURIOSITY_FALLBACK = [
  {
    id: "C_TOKYO_DENSITY",
    blocks: ["G3"],
    text: "Lo sapevi che Tokyo (prefettura) ha una densita' di circa 6.168,7 persone per km²?",
    sourceName: "Nippon.com (dato basato su Statistics Bureau, MIC)",
    sourceUrl: "https://www.nippon.com/en/japan-data/h00782/"
  },
  {
    id: "C_SYRIA_TURKEY",
    blocks: ["G2"],
    text: "Lo sapevi che la Turchia ospita circa 3,2 milioni di rifugiati siriani registrati?",
