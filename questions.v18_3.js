...
const TRAIN_G1 = [
  { type:"lesson", title:"Indicatori e indici demografici", text:"La demografia studia la popolazione attraverso indicatori e indici che permettono confronti tra Paesi." },
  { type:"question", qid:"G1_Q1" },

  { type:"lesson", title:"Natalità, mortalità e fecondità", text:"Natalità e mortalità sono tassi per 1000 abitanti, la fecondità misura i figli per donna." },
  { type:"question", qid:"G1_Q2" },

  { type:"lesson", title:"Saldo naturale e saldo demografico", text:"Il saldo naturale è nati-morti, il saldo demografico include le migrazioni." },
  { type:"question", qid:"G1_Q3" },

  { type:"lesson", title:"Distribuzione e densità della popolazione", text:"La popolazione non è distribuita in modo uniforme sulla Terra." },
  { type:"question", qid:"G1_Q4" },

  { type:"lesson", title:"Piramide d’età", text:"La piramide d’età mostra la struttura della popolazione per età e sesso." },
  { type:"question", qid:"G1_Q5" },

  { type:"lesson", title:"Crescita della popolazione mondiale", text:"La crescita mondiale accelera dal XIX secolo per la diminuzione della mortalità." },
